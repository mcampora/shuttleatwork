...
class GraphTest {
	...
	public void testBuildGraph() {
		...
		assertEquals g.edges["TEMPLIERS"].arcs["GREEN_SIDE"][0].trip.route.route_id, "SB"
		assertEquals g.edges["TEMPLIERS"].arcs["GREEN_SIDE"][0].trip.route.route_long_name, "Amadeus Shuttle - Greenside"
